...
<div id="main">
  ...
  <div id="content">
    ...
    <div class="container">
      ...
      <div class="content">
        <div class="indent">
          <h2>Salah Satu Menu Jawa</h2>
          <img class="img-indent png alt" alt="" src="images/diner.jpg" />
          <div class="extra-wrap">
            <h5>Ayam bakar!</h5>
            <ul class="list2">
              <li>Lezat!</li>
              <li>Terbuat dari ayam kampung!</li>
              <li>Dimasak oleh koki jawa!</li>
              <li></li>
              <li>Terbukti baik untuk kesehatan!</li>
            </ul>
            <div class="aligncenter"><strong class="txt2">Rp 50.000,00</strong></div>
          </div>
        </div>
      </div>
      <div class="clear"></div>

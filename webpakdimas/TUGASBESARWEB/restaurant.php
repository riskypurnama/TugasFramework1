...
<div id="main">
  ...
  <div id="content">
    ...
    <div class="container">
      ...
      <div class="content">
        <div class="indent">
          <h2>Menu unggulan hari ini</h2>
          <img class="img-indent png alt" alt="" src="images/4page-img1.png" />
          <div class="extra-wrap">
            <h5>Foie gras!</h5>
            <ul class="list2">
              <li>Bagus dan lezat!</li>
              <li>Terbuat dari bahan-bahan Perancis!</li>
              <li>Dimasak oleh koki Italia!</li>
              <li>Diberikan oleh Republik Assosiation of chef!</li>
              <li>Terbukti untuk menjadi baik untuk kesehatan Anda!</li>
            </ul>
            <div class="aligncenter"><strong class="txt2">Rp 130.000,00!</strong></div>
          </div>
        </div>
      </div>
      <div class="clear"></div>

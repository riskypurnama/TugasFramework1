...
<head>
<title>JULIANS HOTEL | Restaurant</title>
...
<div id="main">
  ...
  <div id="content">
    ...
    <div class="container">
      <div class="aside maxheight">
        ...
        <div class="box maxheight">
          <div class="inner">
            <h3>Menu</h3>
            <ul class="list3">
              <li><a href="restaurant.php">Specials</a></li>
      ...
      <div class="content">
        <div class="indent">
          <h2>Menu favorit remaja</h2>
          <img class="img-indent png alt" alt="" src="images/lunch.jpg" />
          <div class="extra-wrap">
            <h5>Ayam saos keju!</h5>
            <ul class="list2">
              <li>Lezat!</li>
              <li>Terbuat dari ayam dan keju!</li>
              <li>Dimasak oleh koki bandung!</li>
              <li>Terbukti lezatnya!</li>
            </ul>
            <div class="aligncenter"><strong class="txt2">Rp 75.000,00</strong></div>
          </div>
        </div>
      </div>
      <div class="clear"></div>
